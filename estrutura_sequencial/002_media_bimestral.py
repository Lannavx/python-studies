...
# f = formate = quando voce usa o "f" antes de uma sting, significa que voce está permitindo a formação da mesma, ou seja, usar variáveis ou alterar parâmetros.
# :.2f = formatação = remove as casas extras após a virgula
